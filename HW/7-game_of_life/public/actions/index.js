...
const importSeed = seedName => ({ type: 'IMPORT_SEED', seed: seeds[seedName] });
// ...
...
const randomSeed = () => ({ type: 'RANDOM_SEED' });
const exportMap = () => ({ type: 'EXPORT_MAP' });
const cellClicked = index => ({ type: 'CELL_CLICKED', index: index });
